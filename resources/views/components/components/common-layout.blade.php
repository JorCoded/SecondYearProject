...
<body class="d-flex flex-column min-vh-100">
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg bg-light ">
            ...
            <div class="container-fluid ">
                ...
                <div id="nav-bar" class="collapse navbar-collapse justify-content-center">
                    ...
                    <ul class="navbar-nav " style="background-color: rgb(221, 230, 230); border-radius: 50px; position: relative; left:90px">
                        ...
                        <li class="nav-item mx-2 px-2 rounded-border dropdown">
                            <a id="currency-link" class="nav-link dropdown-toggle" href="#" role="button"
    ...
    <footer class="py-3 mt-auto white">
        ...
        <p class="text-center text-muted border-top pt-3">Copyright © 2026, Designed by <span>Jordy</span></p>
    </footer>
</body>
